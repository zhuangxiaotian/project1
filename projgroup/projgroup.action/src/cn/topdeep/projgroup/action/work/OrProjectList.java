...
public class OrProjectList extends PageAction {
	...
	public List<Project> getProjectList() throws DbException, SQLException, CacheException {
		if(projectList == null){
			projectList = getProjectBiz().projectSelectObjects(0,Integer.MAX_VALUE,"PROJ_ID","desc");
		}
		return projectList;
	}
	...
	public String build() throws Exception{
		if(projectId > 0){
			//build file
			OrmappingProject orProject = getProjectBiz().ormappingProjectSelectByProjId(projectId);
			if(orProject == null){
				return execute();
			}
