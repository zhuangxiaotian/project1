...
public class UserEdit extends BaseAction {
	...
	public void validateSave() throws DbException, SQLException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException, CacheException{
	...
	public void setUserId(int userId) throws DbException, SQLException {
		this.userId = userId;
		if(userId > 0){
