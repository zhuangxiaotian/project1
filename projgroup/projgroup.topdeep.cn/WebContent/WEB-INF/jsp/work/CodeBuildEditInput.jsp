        ...
        <div class="mainContent">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableForm">
            	 <tr >
                    ...
                    <td><s:textfield name="codeBuild.buildName" required="true"></s:textfield></td>
                </tr>
            	 <tr >
                    <td>父构建标识</td>
                    <td><s:textfield name="codeBuild.parentBuildId" required="true"></s:textfield></td>
                </tr>
            	 <tr >
                    <td>相关构建项目标识</td>
                    <td><s:textfield name="codeBuild.funcProjects" required="true"></s:textfield></td>
                </tr>
            	 <tr >
                    <td>构建说明</td>
                    <td><s:textfield name="codeBuild.buildDesc" required="true"></s:textfield></td>
                </tr>
            </table>
