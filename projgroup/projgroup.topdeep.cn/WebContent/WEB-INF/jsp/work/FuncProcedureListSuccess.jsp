        		...
        		var updateTrId = $("#updateTrId").val();
          		  if(jsonObj.funcProcedureId !=null ||jsonObj.funcProcedureId >0){
          			  if(updateTrId !=""){  
              			...
              			"<a href='#' funcProcedureId='"+jsonObj.funcProcedureId+"' class='editProc'>更新</a>&nbsp; <a href='javascript:void(0);' class='deleteProc'>删除</a></td></tr>"));
          			  }  
          		  } 
            }
		});
				...
				<td colspan="13">
					...
					<!--  	<tr>
						...
						<tfoot id="paramListFoot">
							...
							<tr><th colspan="16"><a href="#" class="addParams">添加参数</a></th></tr>
