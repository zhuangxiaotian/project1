			...
			$.ajax({
	            ...
	            success:function(jsonObj){
	            	...
	            	for(var i=data.length-1; i >= 0; i--){
	            		$currTr.after("<tr class='expandTr'><td>&nbsp;</td>			<td>" +((data[i].buildId != null)?data[i].buildId:'') + "</td>			<td>" +((data[i].buildName != null)?data[i].buildName:'') + "</td>            <td>" +((data[i].parentBuildId != null)?data[i].parentBuildId:'') + "</td>            <td>" +((data[i].funcProjects != null)?data[i].funcProjects:'') + "</td>            <td>" +((data[i].pub0 != null)?data[i].pub0:'') + "</td>            <td>" +((data[i].pub1 != null)?data[i].pub1:'') + "</td>            <td>" +((data[i].pub2 != null)?data[i].pub2:'') + "</td>            <td>" +((data[i].pub3 != null)?data[i].pub3:'') + "</td>            <td>" +((data[i].pub4 != null)?data[i].pub4:'') + "</td>            <td>" +((data[i].pub5 != null)?data[i].pub5:'') + "</td>			<td>				<a href=\"work/CodeBuildExecute.action?buildId=" +((data[i].buildId != null)?data[i].buildId:'') + "\">构建</a>				<a href=\"work/CodeBuildEdit.action?buildId=" +((data[i].buildId != null)?data[i].buildId:'') + "\">修改</a>				<a href=\"work/CodeBuildPropertyEdit.action?buildId=" +((data[i].buildId != null)?data[i].buildId:'') + "\">属性</a>				<a href=\"work/CodeBuildProcedureList.action?buildId=" +((data[i].buildId != null)?data[i].buildId:'') + "\">函数选择</a>			<a href=\"work/FuncTestEdit.action?buildId=" +((data[i].buildId != null)?data[i].buildId:'') + "\">参数设置</a>	</td>		</tr>");
	            	}	
	            },
	            error:function(){
	           		alert("失败");
