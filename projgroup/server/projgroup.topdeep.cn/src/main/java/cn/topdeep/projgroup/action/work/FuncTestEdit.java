...
public class FuncTestEdit extends BaseAction{
	...
	public String addsave() throws DbException, SQLException, CacheException{
//		HashMap<String,String> data = new HashMap<String,String>();
		if(procList == null && buildId > 0){
			...
			if(build != null && !StringUtils.isNullOrEmpty(build.getFuncProjects())){
				...
				condition.or().andFuncProjectIdIn(idList);
	...
	public String ajaxAdd() throws DbException, SQLException, CacheException{
