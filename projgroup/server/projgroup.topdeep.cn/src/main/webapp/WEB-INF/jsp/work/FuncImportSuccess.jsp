...
<body>
	...
	<div>
	<s:form method="post">
		<span style="margin-left:130px;">请输入需要导入的函数标识，以逗号分隔</span><input name="importFuncIds" value="" type="text" /><br/>
		<s:hidden name="funcProjectId" />
		<s:submit style="float:right;color:blue;margin-right:700px;" value="提交" method="importFuncs" ></s:submit>
	</s:form>
	</div>
	<br/>
	<br/>
	...
	<div>
	<s:form method="post">
		<span style="margin-left:130px;">请输入需要调整的函数代码前缀参数x|y:z</span><input name="adjustFuncPrefix" value="" type="text" /><br/>
		<s:hidden name="funcProjectId" />
		<s:submit style="float:right;color:blue;margin-right:700px;" value="提交" method="adjustFuncCodes" ></s:submit>
	</s:form>
	</div>
	<div>
