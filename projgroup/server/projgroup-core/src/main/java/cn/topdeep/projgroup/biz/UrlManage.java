...
public class UrlManage {
	...
	public String getDefaultTaskDealUrl(String taskId, String signalName, String retUrl) {
		return getBaseUrl() + "personal/DefaultTaskDeal.action?taskId=" + taskId + "&signalName=" + HttpUtils.urlEncode(signalName) + "&retUrl="
				+ HttpUtils.urlEncode(retUrl);
	}
	...
	public String getCodeBuildPropertyEditNewUrl() {
		return getBaseUrl() + "func/codeBuildPropertyEditManage.do";
	}

	public String getCodeBuildPropertyEditNewUrl(int buildId) {
		return getBaseUrl() + "func/codeBuildPropertyEditManage.do?buildId=" + buildId;
	}

	public String getCodeBuildEditUrl() {
		return getBaseUrl() + "work/codeBuildEdit.do";
	}

	public String getCodeBuildEditUrl(int buildId) {
		return getBaseUrl() + "work/codeBuildEdit.do?buildId=" + buildId;
	}
	...
	public String getCodeBuildProcedureListNewUrl() {
		return getBaseUrl() + "func/codeBuildProcedureListManage.do";
	}

	public String getCodeBuildProcedureListNewUrl(int buildId) {
		return getBaseUrl() + "func/codeBuildProcedureListManage.do?buildId=" + buildId;
	}
	...
	public String getDownFuncProcedurePrivilegeUrl() {
		return getBaseUrl() + "func/downloadConfigFile.do";
	}
